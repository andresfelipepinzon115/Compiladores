...
{
    public class ManejadorTodosErrores
    {
        private Dictionary<TipoError, List<Error>> errores = new Dictionary<TipoError, List<Error>>();
        private static readonly ManejadorTodosErrores INSTANCIA = new ManejadorTodosErrores();

        private ManejadorTodosErrores()
        {
            Limpiar();
        }

        public static ManejadorTodosErrores ObtenerManejadorDeErrores()
        {
            return INSTANCIA;
        }
